# MDN Exercise 01
![gf](public/assets/grassfield.png)
...
このプロジェクトは、[MdN出版「プロの「引き出し」を増やす HTML+CSSコーディングの強化書」](https://books.mdn.co.jp/books/3221303016/)を参考に、Figmaで作成されたデザインをHTML/CSS/JavaScriptで実装した模写練習用のWebサイトです。

主に以下の要素の実装練習を目的としています：
- **ヘッダー**: ナビゲーションメニュー、ハンバーガーメニューの実装
- **フッター**: フッターメニューとコピーライトの配置
- **カード型レイアウト**: サービス一覧や商品ピックアップなど、カード型コンポーネントの実装

レスポンシブデザインに対応し、モバイルファーストのアプローチで実装されています。
